		...
		<section class="isotop-box">
			<div class="container">
				...
				<br><br><br><table class="table table-hover">
					<tbody>
						<tr>
						    <th width="250px">Id Pengembalian</th>
							<th width="250px">Nama Penyewa</th>
						    <th width="250px">Tanggal di Kembalikan</th>
						    <th width="250px">Tanggal Seharusnya dikembalikan</th>
					    ...
					    <tr class="table-active">
					   		<th scope="row"><?php echo $hasil->id_pengembalian; ?></th>
					    	...
					    	<td>
					    		...
					    		<?php echo anchor('PageAdmin/deletePengembalian/'. $hasil->id_pengembalian,'Delete'); ?>
					    	</td>
					    </tr>
					    <?php } ?>
				...
				<div align="left">
					<a href="<?php echo site_url('PageAdmin/formInsertPengembalian');?>">+ Tambah Data</a>
				</div>
