	...
	<main id="page-content">
		...
		<section class="isotop-box">
			<div class="container">
				<div class="row">
				<div class="form-card">
					<form method="POST" action="<?php echo site_url('PageAdmin/insertPengembalian');?>">
						<label align="center">Id Peminjaman : </label>
						<select name="id_peminjaman">
							<?php foreach ($result as $hasil) { ?>
							<option value="<?php echo $hasil->id_peminjaman; ?>"><?php echo $hasil->id_peminjaman . " - " . $hasil->nama_pengguna; ?></option>
							<?php }?>
						</select><br><br>
						<label align="center">Nama Pemesan : </label>
						<select name="id_pengguna">
							<?php foreach ($result as $hasil) { ?>
							<option value="<?php echo $hasil->id_pengguna; ?>"><?php echo $hasil->nama_pengguna; ?></option>
							<?php }?>
						</select><br><br>
						<label align="center">Tanggal Pengembalian : </label>
						<input type="date" size="35" name="tgl_pengembalian" placeholder="Tanggal Pengembalian"><br><br>
						<label align="center">Tanggal Seharusya : </label> &ensp; &ensp;
						<input type="date" size="35" name="tgl_seharusnya" placeholder="Tanggal Seharusnya"><br><br>
						<input type="text" size="35" name="ketelatan" placeholder="Ketelatan"><br><br>
						<input type="text" size="35" name="denda" placeholder="Denda"><br><br>
