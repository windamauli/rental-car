...
<body class="page__home">
	...
	<main id="page-content">
		...
		<h3 align="center">Data Pemesanan</h3><br>
				...
				<br><br><br><table class="table table-hover">
					<tbody>
						<tr>
							...
							<th width="250px">Nama Pemesan</th>
						    <th width="250px">No. Telepon Pemesan</th>
						    <th width="250px">Merk Mobil</th>
						    <th width="250px">No. Polisi</th>
						    <th width="250px">Tanggal Pesan</th>
						    <th width="250px">Waktu Pengambilan</th>
						    <th width="250px">Waktu Pengembalian</th>
						    <th width="250px">Lokasi Pengambilan</th>
						    <th width="250px">Lokasi Pengembalian</th>
						    <th align="right"></th>
						</tr>
						<?php foreach ($result as $hasil) { ?>
					    <tr class="table-active">
					   		<th scope="row"><?php echo $hasil->id_pemesanan; ?></th>
					    	<td><?php echo $hasil->nama_pemesan; ?></td>
					    	<td><?php echo $hasil->notlp_pemesan; ?></td>
					    	<td><?php echo $hasil->merk_mobil; ?></td>
					    	<td><?php echo $hasil->no_polisi; ?></td>
					    	<td><?php echo $hasil->tanggal_pemesanan; ?></td>
					    	<td><?php echo $hasil->waktu_pengambilan; ?></td>
					    	<td><?php echo $hasil->waktu_pengembalian; ?></td>
					    	<td><?php echo $hasil->lokasi_pengambilan; ?></td>
					    	<td><?php echo $hasil->lokasi_pengembalian; ?></td>
					    	<td>
					    		<?php echo anchor('PageAdmin/deletePemesanan/'. $hasil->id_pemesanan,'Delete'); ?>
					    	</td>
					    </tr>
					    <?php } ?>
