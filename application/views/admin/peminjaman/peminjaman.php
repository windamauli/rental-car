...
<body class="page__home">
	...
	<main id="page-content">
		...
		<h3 align="center">Data Peminjaman Mobil</h3><br>
		<section class="isotop-box">
			<div class="container">
				...
				<br><br><br><table class="table table-hover">
					<tbody>
						<tr>
						    ...
						    <th width="250px">Uang Muka</th>
						    <th width="250px">Jaminan</th>
						    <th align="right"></th>
						</tr>
						<?php foreach ($result as $hasil) { ?>
					    <tr class="table-active">
					   		<th scope="row"><?php echo $hasil->id_peminjaman; ?></th>
					    	...
					    	<td><?php echo $hasil->uang_dp; ?></td>
					    	<td><?php echo $hasil->jaminan; ?></td>
					    	<td>
					    		
					    		<?php echo anchor('PageAdmin/deletePeminjaman/'. $hasil->id_peminjaman,'Delete'); ?>
					    	</td>
					    </tr>
					    <?php } ?>
				...
				<div align="left">
					<a href="<?php echo site_url('PageAdmin/formInsertPeminjaman');?>">+ Tambah Data</a>
				</div>
