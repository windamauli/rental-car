...
<body class="page__home">
	...
	<main id="page-content">
		...
		<h3 align="center">Input Data Mobil</h3><br>
		<section class="isotop-box">
			<div class="container">
				<div class="row">
				<div class="form-card">
					<form method="POST" action="<?php echo site_url('PageAdmin/insertMobil');?>">
						<label align="center">Nama Pemilik : </label>
						<select name="id_owner">
							<?php foreach ($result as $hasil) { ?>
							<option value="<?php echo $hasil->id_owner; ?>"><?php echo $hasil->nama_owner; ?></option>
							<?php }?>
						</select><br><br>
						<input type="text" size="35" name="merk_mobil" placeholder="Merk Mobil"><br><br>
						<input type="text" size="35" name="warna" placeholder="Warna"><br><br>
						<input type="text" size="35" name="no_polisi" placeholder="No. Polisi"><br><br>
						<input type="text" size="35" name="no_mesin" placeholder="No. Mesin"><br><br>
						<input type="text" size="35" name="no_bpkb" placeholder="No. BPKB"><br><br>
						<input type="text" size="35" name="jumlah_kursi" placeholder="Jumlah Kursi"><br><br>
						<input type="text" size="35" name="status" placeholder="Status"><br><br>
						<input type="text" size="35" name="harga" placeholder="harga"><br><br>
						<input type="text" size="35" name="image" placeholder="image"><br><br>
