...
<body class="page__home">
	...
	<main id="page-content">
		...
		<h3 align="center">Data Untuk Pengolahan Laporan</h3><br>
				...
				<br><br><br><table class="table table-hover">
					<tbody>
						<tr>
						    ...
						    <th width="250px">Tanggal Dikembalikan</th>
						    <th width="250px">Ketelatan</th>
						    <th width="250px">Denda</th>
					    ...
					    <tr class="table-active">
					   		<th scope="row"><?php echo $hasil->id_laporan; ?></th>
					    	...
					    	<td><?php echo $hasil->tgl_seharusnya; ?></td>
					    	<td><?php echo $hasil->ketelatan; ?></td>
					    	<td><?php echo $hasil->denda; ?></td>
					    	<td><?php echo $hasil->total_harga; ?></td>
					    	<td>

					    		
					    		<?php echo anchor('PageAdmin/deleteLaporan/'. $hasil->id_laporan,'Delete'); ?>
					    	</td>
					    </tr>
					    <?php } ?>
