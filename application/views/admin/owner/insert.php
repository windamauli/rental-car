...
<body class="page__home">
	...
	<main id="page-content">
		...
		<h3 align="center">Input Data Pemilik Mobil</h3><br>
		<section class="isotop-box">
			<div class="container">
				<div class="row">
				<div class="form-card">
					<form method="POST" action="<?php echo site_url('PageAdmin/insertOwner');?>">

						<input type="text" size="35" name="nama_owner" placeholder="Nama Pemilik Mobil"><br><br>
						<input type="text" size="35" name="notlp_owner" placeholder="No. Telepon Pemilik Mobil"><br><br>
						<input type="text" size="35" name="alamat_owner" placeholder="Alamat Pemilik Mobil"><br><br>
