...
<body class="page__home">
	...
	<main id="page-content">
		...
		<h3 align="center">Edit Data Pemilik Mobil</h3><br>
		<section class="isotop-box">
			<div class="container">
				<div class="row">
				<div class="form-card">
					<form method="POST" action="<?php echo site_url('PageAdmin/updateOwner');?>">

					<?php foreach ($result as $hasil) { ?>
						<input type="text" size="35" name="id_owner" value="<?php echo $hasil->id_owner; ?>" ><br><br>
						<input type="text" size="35" name="nama_owner" value="<?php echo $hasil->nama_owner; ?>"><br><br>
						<input type="text" size="35" name="notlp_owner" value="<?php echo $hasil->notlp_owner; ?>" ><br><br>
						<input type="text" size="35" name="alamat_owner" value="<?php echo $hasil->alamat_owner; ?>"><br><br>
