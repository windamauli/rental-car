...
<body class="page__home">
	...
	<main id="page-content">
		...
		<h3 align="center">Data Pemilik Mobil</h3><br>
		<section class="isotop-box">
			<div class="container">
				...
				<br><br><br><table class="table table-hover">
					<tbody>
					    ...
					    <tr class="table-active">
					   		<th scope="row"><?php echo $hasil->id_owner; ?></th>
					    	<td><?php echo $hasil->nama_owner; ?></td>
					    	<td><?php echo $hasil->notlp_owner; ?></td>
					    	<td><?php echo $hasil->alamat_owner; ?></td>
					    	<td>
					    		<a href="<?php echo site_url('PageAdmin/formUpdateOwner/' . $hasil->id_owner); ?>">Update</a> &emsp;
					    		<?php echo anchor('PageAdmin/deleteOwner/'. $hasil->id_owner,'Delete'); ?>
					    	</td>
					    </tr>
					    <?php } ?>
				...
				<div align="left">
					<a href="<?php echo site_url('PageAdmin/formInsertOwner');?>">+ Tambah Data</a>
				</div>
