...
<head>
	...
	<title>Bandung Rental Car</title>
				...
				<div class="container">
					...
					<!-- Left nav -->
						<ul class="menu-navigation__list nav navbar-nav">
							<li class="current"><a href="#" data-hover="Home">Beranda</a></li>
					...
					<div class="col-lg-12">
						<form id="book-form" class="book-form" action="#">
							...
							<div class="book-form__btn">
								<a href="<?php echo site_url('Page/daftarmobil')?>" type="submit" class="btn">PILIH MOBIL</a>
							</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-lg-6 col-lg-push-6"> 
					...
					<p>Bandung Rental Cars adalah sebuah situs penyewaan mobil untuk wilayah Bandung dan Sekitarnya. Dengan pilihan mobil yang banyak dan dapat memilih mobil sesuai kebutuhan serta dapat pula memilih mobil sesuai dengan jumlah kursi pada mobil. Kami telah terikat dengan banyak pemilik mobil, sehingga jasa rental kami memiliki harga sewa paling ekonomis. </p>
					<ul class="list__marker">
						<li>Jaminan Harga Terbaik</li>
						<li>Tidak ada biaya pembatalan sewa</li>
						<li>Tidak ada pembayaran yang tersembunyi</li>
					</ul>
					<a href="<?php echo site_url('page/login')?>" class="btn">Masuk</a>
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-6">
						<div class="copyright">&copy; 2018 | <a href="#">Bandung Rental Car</a></div><br>
