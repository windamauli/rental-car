			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-3">
						<form method="post" action="<?php echo site_url('Page/daftarmobilByJumlahKursi');?>">
						<div class="filter-box">
							...
							<div class="filter-widget">
								...
								<div align="center">
								<input type="submit" name="submit" class="btn btn-mini" value="CARI" ></a></div><br>
						...
						<div class="gallery row" id="gallery">
							...
							<div class="gallery__item col-xs-12 col-sm-6 col-xl-4">
								<figure class="gallery__item__image">
									<a class="hover" href="<?php echo site_url('Page/detail/' . $hasil->id_mobil)?>">
								...
								<div class="gallery__item__content">
									...
									<br><a href="<?php echo site_url('Page/detail/' . $hasil->id_mobil)?>" class="link-gallery">Lihat Selengkapnya</a>
