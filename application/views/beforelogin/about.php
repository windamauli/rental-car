						...
						<div class="breadcrumbs__items">
							<div class="breadcrumbs__wrap">
								<div class="breadcrumbs__item">
									<a href="<?php echo site_url('Page/index')?>" class="#breadcrumbs__item-link">Beranda</a> <span>/</span> <a href="#" class="breadcrumbs__item-link">Tentang Kami</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row info-box">
				<div class="col-xs-12">
					<article>
						...
						<a href="#"  data-remodal-target="modal" class="btn">PESAN</a>
