						...
						<div class="breadcrumbs__items">
							<div class="breadcrumbs__wrap">
								<div class="breadcrumbs__item">
									<a href="<?php echo site_url('Page/index')?>" class="#breadcrumbs__item-link">Beranda</a> <span>/</span> <a href="#" class="breadcrumbs__item-link">Daftar Mobil</a><span>/</span> <a href="#" class="breadcrumbs__item-link">Detail Mobil</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="model-details-box">
						<div class="model-details-box__inner">
							...
							<div class="model-details-box__info">
								...
								<a href="<?php echo site_url('Pageafterlogin/rentalmobil/' . $hasil->id_mobil);?>" class="btn">PESAN SEKARANG</a>
							</div>
